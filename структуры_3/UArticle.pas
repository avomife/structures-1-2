...
begin
  ...
  readln(fnameArt);
  repeat
    writeln('Введите страницу начала');
    readln(fstartPg);
    writeln('Введите страницу конца');
    readln(fendPg);
...
begin
  ...
  writeln(f, 'Название журнала: '+fnameArt);
  writeln(f, 'Начало: '+intTostr(fstartPg));
  writeln(f, 'Конец: '+intTostr(fendPg));
end;
